		...
		<Grid container>
			<Grid item sm={6} lg={8} xl={8}>
				...
				<p className={classes.paragraph}>
					Hey! I’m Joe - an Irish-born, but now London-based digital media and
					cinema professional. I have a 1st class honours M.Sc. in{' '}
					<a
				...
				<p className={classes.paragraph}>
					...
					clients, which can be found on the website I created:{' '}
					<a
